...
def build_best_epoch_markers(
    ...
    phase_boundary: int,
) -> Tuple[List[MetricMarker], Optional[str], Optional[int], Optional[int], Optional[int]]:
    ...
    return marker_lines, marker_note, train_best_local, fine_best_local, fine_best_global
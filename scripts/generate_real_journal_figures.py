#!/usr/bin/env python3
"""Generate real journal figures from repository artifacts and dataset images."""
...
REPORT_PATH = ROOT / "docs" / "reports" / "evaluation_report.json"
...
def plot_crop_distribution(counts: dict) -> None:
    ...
    save_plot(PLOTS_DIR / "journal_crop_distribution.png")
...
def plot_class_imbalance(counts: dict) -> None:
    ...
    save_plot(PLOTS_DIR / "journal_class_imbalance.png")
...
def plot_top_bottom_classes(counts: dict) -> None:
    ...
    save_plot(PLOTS_DIR / "journal_top_bottom_classes.png")
...
def plot_per_class_f1(report: dict) -> None:
    ...
    plt.xlim(0, 102)
    save_plot(PLOTS_DIR / "journal_per_class_f1_ranked.png")
...
def plot_precision_recall_support(report: dict) -> None:
    ...
    save_plot(PLOTS_DIR / "journal_precision_recall_support.png")
...
def plot_crop_level_f1(report: dict) -> None:
    ...
    save_plot(PLOTS_DIR / "journal_crop_level_f1.png")
...
def plot_top_confusions(report: dict) -> None:
    ...
    save_plot(PLOTS_DIR / "journal_top_confusions.png")
...
def plot_error_share_by_crop(report: dict, class_order: list[str]) -> None:
    ...
    save_plot(PLOTS_DIR / "journal_error_share_by_crop.png")
...
def plot_rice_confusion(report: dict, class_order: list[str]) -> None:
    ...
    save_plot(PLOTS_DIR / "journal_rice_confusion_matrix.png")
...
def plot_training_dynamics(history: list[dict]) -> None:
    ...
    save_plot(PLOTS_DIR / "journal_training_dynamics.png")
...
def build_crop_gallery(counts: dict) -> None:
    ...
    make_labeled_gallery(items, PLOTS_DIR / "journal_crop_gallery_real.png", cols=4, thumb_size=(780, 600))
...
def build_hard_class_gallery(report: dict, counts: dict) -> None:
    ...
    make_labeled_gallery(items, PLOTS_DIR / "journal_hard_class_gallery_real.png", cols=4, thumb_size=(760, 560))
...
def build_misclassification_gallery() -> None:
    ...
    make_labeled_gallery(items, PLOTS_DIR / "journal_misclassification_gallery_real.png", cols=2, thumb_size=(1200, 900))
...
def build_case_gallery(counts: dict) -> None:
    ...
    make_labeled_gallery(items, PLOTS_DIR / "case_gallery_real.png", cols=4, thumb_size=(840, 620))
...
def plot_system_workflow() -> None:
    ...
    save_plot(PLOTS_DIR / "journal_system_workflow.png")
...
def plot_artifact_lineage() -> None:
    ...
    draw_box(ax, (0.52, 0.66), 0.18, 0.14, "docs/reports/\nevaluation_report.json", "#d8f3dc")
    draw_box(ax, (0.75, 0.66), 0.20, 0.14, "plots/\nconfusion_matrix.png\nlearning_curves.png", "#d8f3dc")

    draw_box(ax, (0.20, 0.34), 0.24, 0.14, "scripts/generate_journal_tables.py\nscripts/generate_real_journal_figures.py", "#ffe8d6")
    draw_box(ax, (0.56, 0.34), 0.24, 0.14, "scripts/build_journal.sh\nlatexmk", "#ffe8d6")
    draw_box(ax, (0.38, 0.08), 0.24, 0.14, "docs/journal/main.pdf\nsource archive", "#f1c0e8")
    ...
    ax.text(0.5, 0.92, "Artifact Lineage for the Journal Build", ha="center", va="center", fontsize=16, fontweight="bold")
    save_plot(PLOTS_DIR / "journal_artifact_lineage.png")

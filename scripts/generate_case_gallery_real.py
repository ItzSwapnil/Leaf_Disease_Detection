"""Build a case gallery PNG by sampling real images from dataset/train.

Usage: python scripts/generate_case_gallery_real.py
Saves: plots/case_gallery_real.png
"""
...
OUT = ROOT / "plots" / "case_gallery_real.png"

...
def generate_class_distribution():
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(PLOTS_DIR, "class_distribution.png"), dpi=800, bbox_inches="tight")
    plt.close()
...
def generate_confusion_matrix():
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(PLOTS_DIR, "confusion_matrix.png"), dpi=800, bbox_inches="tight")
    plt.close()
...
def generate_learning_curves_from_logs():
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(PLOTS_DIR, "learning_curves.png"), dpi=800, bbox_inches="tight")
    plt.close()
...
def generate_model_architecture_diagram():
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(PLOTS_DIR, "model_architecture.png"), dpi=800, bbox_inches="tight")
    plt.close()
...
def generate_sample_predictions():
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(PLOTS_DIR, "sample_predictions.png"), dpi=800, bbox_inches="tight")
    plt.close()

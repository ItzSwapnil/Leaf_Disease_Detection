...
CONFIDENCE_REJECT_THRESHOLD = _env_float(
    "LEAF_CONFIDENCE_REJECT_THRESHOLD", 0.70
)
# Entropy threshold mode:
# - <= 1.0: normalized entropy ratio (0..1)
# - > 1.0: entropy in bits
ENTROPY_REJECT_THRESHOLD = _env_float("LEAF_ENTROPY_REJECT_THRESHOLD", 0.35)
OOD_MSP_THRESHOLD = _env_float("LEAF_OOD_MSP_THRESHOLD", 0.70)
